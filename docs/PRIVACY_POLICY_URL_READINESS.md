...
- 공개 개인정보 처리방침 URL 후보 페이지에는 이전 브랜드 오타가 남아 있지 않아야 합니다.
...
이 문서는 하루풀리 앱을 Google Play에 제출하기 전 개인정보 처리방침 URL을 준비하기 위한 체크리스트입니다.
...
하루풀리는 현재 서버 데이터베이스 없이 사용자의 기기 브라우저 또는 Android WebView의 localStorage를 중심으로 프로필, 운세 cache, 동의 설정, 저장한 풀이, 방문 streak 등의 정보를 저장합니다.
...
하루풀리의 운세와 사주 결과는 오락 및 참고용 콘텐츠이며, 의학, 법률, 투자, 진로, 심리 상담 등 전문적인 자문을 대체하지 않습니다.
