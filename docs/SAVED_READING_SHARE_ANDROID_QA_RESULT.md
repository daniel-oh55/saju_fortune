...
| QA item | Status | Note |
|---|---|---|
| Android Debug Build artifact prepared | Completed | run #253 기준 |
...
| Share text excludes birthDate | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
| Share text excludes birthTime | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
| Share text excludes birthPlace | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
| Share text excludes gender | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
| Share text excludes name | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
| Share text excludes real store URLs | Completed | 메모장/카카오톡 입력창에 붙여넣어 미포함 확인 |
...
- Android Debug Build run #253 APK 기준으로 clipboard fallback 공유 문구를 실제 붙여넣기 확인했습니다.
- 공유 문구에 birthDate, birthTime, birthPlace, gender, name 및 실제 Google Play/App Store URL이 포함되지 않음을 확인했습니다.
- Android share sheet는 여전히 열리지 않았고 clipboard fallback 경로로 확인했습니다.
- 실제 외부 공유 발송은 수행하지 않았습니다.
