...
const guardedDiffOutput = [
  execSync(`git diff -- ${appPath} ${packagePath} scripts/checkTodayFortuneBackNavigation.mjs`, { encoding: 'utf8' }),
  execSync(`git diff --cached -- ${appPath} ${packagePath} scripts/checkTodayFortuneBackNavigation.mjs`, {
    encoding: 'utf8',
  }),
].join('\n');
const changedFiles = [
