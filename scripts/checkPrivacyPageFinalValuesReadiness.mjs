...
const resultDocPath = 'docs/PRIVACY_PAGE_FINAL_VALUES_READINESS.md';
...
if (!fs.existsSync(path.join(projectRoot, resultDocPath))) {
  console.error('Privacy page final values readiness check failed');
...
const requiredDocSnippets = [
  ...
  'Purpose: Document final value readiness before implementing the app-hosted privacy policy page',
  'PR type: docs/check-only',
  'App name: 하루풀이',
  'Related app-hosted privacy page implementation plan PR: #352',
  'Required final values',
  'Support contact readiness checklist',
  'Effective date readiness checklist',
  'Provider/developer information readiness checklist',
  'Privacy page implementation blockers',
...
mark(
  developmentLogSource.includes('## Privacy Page Final Values Readiness'),
...
mark(
  packageJsonSource.includes(
    '"check:privacy-page-final-values-readiness": "node scripts/checkPrivacyPageFinalValuesReadiness.mjs"',
  ),
...
console.log('Privacy page final values readiness check passed');
