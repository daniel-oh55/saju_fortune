...
const resultDocPath = 'docs/PRIVACY_URL_SUPPORT_CONTACT_FINALIZATION_CHECKLIST.md';
...
if (!fs.existsSync(path.join(projectRoot, resultDocPath))) {
  console.error('Privacy URL and support contact finalization checklist check failed');
...
const requiredDocSnippets = [
  ...
  'Purpose: Define the finalization checklist for privacy policy URL and support contact before Google Play Console input',
  ...
  'Required final values before Console input',
  '개인정보 처리방침 URL 후보 선정',
...
mark(
  developmentLogSource.includes('## Privacy URL and Support Contact Finalization Checklist'),
...
mark(
  packageJsonSource.includes(
    '"check:privacy-url-support-contact-finalization-checklist": "node scripts/checkPrivacyUrlSupportContactFinalizationChecklist.mjs"',
  ),
...
console.log('Privacy URL and support contact finalization checklist check passed');
